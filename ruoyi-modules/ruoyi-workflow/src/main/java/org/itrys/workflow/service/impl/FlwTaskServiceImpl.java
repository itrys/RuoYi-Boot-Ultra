package org.itrys.workflow.service.impl;
...
import org.itrys.boot.mybatis.utils.IdGeneratorUtil;
...
import org.itrys.workflow.common.enums.MessageTypeEnum;
import org.itrys.workflow.common.enums.TaskAssigneeType;
import org.itrys.workflow.common.enums.TaskOperationEnum;
...
import org.itrys.workflow.domain.vo.FlowCopyVo;
import org.itrys.workflow.domain.vo.FlowHisTaskVo;
import org.itrys.workflow.domain.vo.FlowTaskVo;
import org.itrys.workflow.domain.vo.NodeExtVo;
import org.itrys.workflow.mapper.FlwCategoryMapper;
import org.itrys.workflow.mapper.FlwHisTaskMapper;
import org.itrys.workflow.mapper.FlwInstanceBizExtMapper;
import org.itrys.workflow.mapper.FlwTaskMapper;
import org.itrys.workflow.service.IFlwCommonService;
import org.itrys.workflow.service.IFlwNodeExtService;
import org.itrys.workflow.service.IFlwTaskAssigneeService;
import org.itrys.workflow.service.IFlwTaskService;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;

import java.util.*;

import static org.itrys.workflow.common.constant.FlowConstant.*;
...
public class FlwTaskServiceImpl implements IFlwTaskService {
    ...
    public void setCopy(Task task, List<FlowCopyBo> flowCopyList) {
        ...
        flwCommonService.sendMessage(
            List.of(MessageTypeEnum.SYSTEM_MESSAGE.getCode()),
            "您收到一条新的流程抄送，请及时查看。",
            "单据抄送提醒",
